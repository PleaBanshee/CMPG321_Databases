...
CREATE TABLE DAMAGE_COST (
    ...
    CONSTRAINT FK3_DAMAGE_COST FOREIGN KEY(LGA_Code) REFERENCES LGA(LGA_Code),
    CONSTRAINT FK4_DAMAGE_COST FOREIGN KEY(Assessor_ID) REFERENCES ASSESSOR(Assessor_ID)
);
